...
export default function Navbar() {
  ...
  return (
    <div className="navbar bg-base-100 lg:px-12">
      ...
      <Link to="/sell">
          <h1 className="focus:outline-none text-white bg-lightgreen-700 hover:bg-lightgreen-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-lightgreen-600 dark:hover:bg-green-700 dark:focus:ring-green-800 ">Sell </h1>
          <span></span>
        </Link>
        {/* Search group */}
        <div>
